  ...
  return (
    <SimpleGrid cols={{ md: 1, sm: 1 }}>
      {cash < 0 ? (
        ...
        >
          <Text mt="md">
            You lose because you run out of cash. While you are happy, you still
            need some cash to meet your daily needs.
          </Text>
          ...
          <Text>
            ...
            <br />
            30% Wants – Fun stuff like dining out, entertainment, and shopping.
            <br />
            20% Savings – Emergency fund, investments, and debt repayment.
            <br />
            Stick to this rule to build pension while covering expenses!
            <br />
          </Text>
        </SummaryLoseCard>
      ) : (
        ...
        >
          <Text mt="md">
            You lose because your happiness rating drop below 25%. While basic
            needs are met you have little or no enjoyment or contentment.
          </Text>
        </SummaryLoseCard>
      )}
      <Button
