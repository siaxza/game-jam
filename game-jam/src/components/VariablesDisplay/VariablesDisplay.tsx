...
export const VariablesDisplay = () => {
  ...
  return (
    <SimpleGrid cols={{ md: 4, base: 2 }}>
      <motion.div key={gameState.cash} initial={{scale: 1}} animate={{scale: [0.5, 1]}}>
      <ValueDisplay
        text="Cash"
      ...
      <motion.div key={gameState.happiness} initial={{scale: 1}} animate={{scale: [0.5, 1]}}>
      <BarDisplay
        text="Happiness"
      ...
      <motion.div key={gameState.pension} initial={{scale: 1}} animate={{scale: [0, 1]}}>
      <PensionPot potData={gameState.pension} />
      </motion.div>


      <motion.div key={gameState.round} initial={{scale: 1}} animate={{scale: [0.5, 1]}}>
      <ValueDisplay
        text="Round"
